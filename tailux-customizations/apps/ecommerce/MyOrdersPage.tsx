// MyOrdersPage — order history with detail rail + status filter.
//
// Layout:
...
//
// Backend: real `useOrders()` hook (P3-A5). Filters and the detail rail are
// pure UI state on top of the loaded list.
...
const FILTERS: Array<{ id: FilterId; label: string; statuses: OrderStatus[] }> =
  [
    { id: "all", label: "All", statuses: ["paid", "pending", "failed", "refunded", "canceled"] },
    { id: "paid", label: "Completed", statuses: ["paid"] },
