...
var (
        AccountCreationLimit    = RateLimitConfig{MaxRequests: 1000, Window: time.Hour}
        LoginAttemptLimit       = RateLimitConfig{MaxRequests: 1000, Window: 15 * time.Minute}
        PasswordResetLimit      = RateLimitConfig{MaxRequests: 100, Window: time.Hour}
        ResendVerificationLimit = RateLimitConfig{MaxRequests: 100, Window: 60 * time.Second}
        OAuthInitLimit          = RateLimitConfig{MaxRequests: 1000, Window: time.Minute}
        EmailVerificationLimit  = RateLimitConfig{MaxRequests: 1000, Window: time.Hour}
        TokenRefreshLimit       = RateLimitConfig{MaxRequests: 1000, Window: time.Minute}
        InvitationLimit         = RateLimitConfig{MaxRequests: 100, Window: time.Hour}
        MFAChallengeLimit       = RateLimitConfig{MaxRequests: 100, Window: 5 * time.Minute}
