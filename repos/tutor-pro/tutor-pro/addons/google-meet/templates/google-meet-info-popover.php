<?php
/**
 * Google lesson card info popover content.
 *
...
<div>
	<div class="tutor-border-b tutor-px-5 tutor-py-4">
		...
		<div class="tutor-google-meet-info-link">
			<div class="tutor-text-primary tutor-small"><?php echo esc_url( $data['meet_link'] ); ?></div>
			<?php
			Button::make()
				->icon( Icon::COPY_2 )
				...
				->attrs(
					array(
						'x-on:click' => "copy('" . $data['meet_link'] . "')",
	...
	<div class="tutor-px-5 tutor-py-4">
		...
		<div class="tutor-google-meet-info-host-email">
			<div class="tutor-text-primary tutor-small"><?php echo esc_html( $data['host_email'] ); ?></div>
		</div>
	</div>
</div>