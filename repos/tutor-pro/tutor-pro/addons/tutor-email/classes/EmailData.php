		...
		$email_array = array(
			'email_to_all'      => array(
				'forgot_password' => array(
					'label'        => __( 'Forgot Password', 'tutor-pro' ),
					'default'      => 'on',
					'editable'     => false,
					'template'     => 'to_all_forgot_password',
					'tooltip'      => __( 'Forgot password email notification', 'tutor-pro' ),
					'subject'      => __( 'Forgot Password', 'tutor-pro' ),
					'heading'      => __( 'Reset your password', 'tutor-pro' ),
					'message'      => json_encode( 'Hi {user_name}! <br/>We received a request to reset the password for your account on {site_name}. Click the button below to reset your password.' ),
			...
			'email_to_students' => array(
				...
				'feedback_submitted_for_quiz' => array(
					...
					'block_heading' => __( 'Instructor Note', 'tutor-pro' ),
					'block_content' => __( 'What does it take to be successful? Ask around and you will find different answers to the formula of success. The truth is, success leaves clues and you can achieve.', 'tutor-pro' ),
					'placeholders'  => EmailPlaceholder::only( array( 'course_name', 'course_url', 'site_url', 'site_name', 'quiz_name', 'total_marks', 'earned_marks', 'instructor_name', 'user_name', 'instructor_feedback', 'review_url', 'quiz_review_url' ) ),
				),
				...
				'gifted_a_course'             => array(
					'label'        => __( 'Gift Course Purchase Confirmation', 'tutor-pro' ),
					'default'      => 'on',
					'template'     => 'to_user_gifted_a_course',
					'tooltip'      => __( 'Enable to confirm the gift course purchase to the buyer', 'tutor-pro' ),
					...
					'message'      => json_encode( 'You\'ve successfully gifted <strong>{course_name}</strong> course to <strong>{recipient_name}</strong>. The delivery is scheduled for {delivery_date}.' ),
					'footer_text'  => __( 'The recipient will be automatically enrolled in the course once they accept the gift.', 'tutor-pro' ),
					'placeholders' => EmailPlaceholder::only( array( 'course_name', 'site_url', 'site_name', 'user_name', 'delivery_date', 'recipient_name', 'gift_message' ) ),
				),
				'received_a_gifted_course'    => array(
					'label'        => __( 'Gift Course Delivery Notification', 'tutor-pro' ),
					'default'      => 'on',
					'template'     => 'to_user_received_a_gifted_course',
					'tooltip'      => __( 'Enable to notify the recipient when the gift course is delivered.', 'tutor-pro' ),
					'subject'      => __( 'Congrats! A Special Gift Is Ready for You 🎁', 'tutor-pro' ),
					'heading'      => __( 'Great news!', 'tutor-pro' ),
					'message'      => json_encode( '<strong>{buyer_name}</strong> has gifted you the <strong>{course_name}</strong> course on <strong>{site_name}</strong>.' ),
					'footer_text'  => __( "Note: You'll be automatically registered in {site_name} once you accept the gift.", 'tutor-pro' ),
					'placeholders' => EmailPlaceholder::only( array( 'course_name', 'buyer_name', 'course_url', 'site_url', 'site_name', 'user_name', 'delivery_date', 'recipient_name', 'gift_message' ) ),
				),
			),
