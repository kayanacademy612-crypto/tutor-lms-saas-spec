...
<div class="tutor-gc-streams">
	<div tutor-gc-streams>
		<?php require 'stream-individual.php'; ?>
	</div>

	<?php if ( $stream_next_token ) : ?>
		<div class="tutor-text-center tutor-mt-32">
			<a href="#" class="tutor-btn tutor-btn-outline-primary" tutor-gc-stream-loader data-next_token="<?php echo esc_attr( $stream_next_token ); ?>" data-course_id="<?php echo esc_attr( $course_id ); ?>"><?php esc_html_e( 'Load More', 'tutor-pro' ); ?></a>
		</div>
	<?php endif; ?>
</div>
